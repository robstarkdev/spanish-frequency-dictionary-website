...
<head>
    ...
    <title>Spanish Frequency Dictionary iPhone & Android App</title>

    <?php include "incHeadTag.php";   ?>
...
<div class="strip strip_one_liner">

    <div class="strip_one_liner_text_box">
...
<div class="strip strip_downloads">

    <a class="strip_downloads_item" href="https://play.google.com/store/apps/details?id=com.robstarkdev.newrndictionary">
...
<div class="strip strip_screenshots">

    <img src="images/app_screenshot_1_final.jpg" alt="" class="strip_screenshots_image">
    <img src="images/app_screenshot_2_final.jpg" alt="" class="strip_screenshots_image">

</div>


<div class="strip strip_video">
    <iframe width="560" height="315" src="https://www.youtube.com/embed/EXQrYkn_Z8k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>

<div class="strip strip_explanation_text">
...
<br><br>
       ...
       The app also allows you to save words for review later in the "Review/Quiz" section of the application.
        You can add or delete words to your saved vocabulary list as you look them up.
